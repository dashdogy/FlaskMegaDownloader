...
MAX_CONCURRENT_DOWNLOADS = int(os.environ.get("MEGA_DOWNLOADER_MAX_CONCURRENT_DOWNLOADS", "1"))
MAX_CONCURRENT_DOWNLOADS_LIMIT = int(os.environ.get("MEGA_DOWNLOADER_MAX_CONCURRENT_DOWNLOADS_LIMIT", "8"))
